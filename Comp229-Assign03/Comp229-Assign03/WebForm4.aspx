...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Default_List">
          ...
          <asp:Label ID="lblCid" runat="server" Text="CourseID"></asp:Label><br />
           ...
           --%> 
              <asp:GridView ID="CourseGridView" runat="server" horizontalalign="Center" AutoGenerateColumns="False" DataKeyNames="StudentID" AutoGenerateDeleteButton="True" OnSelectedIndexChanged="CourseGridView_SelectedIndexChanged" >
                  <Columns>
...
<%--                      <asp:BoundField DataField="Title" HeaderText="Title" SortExpression="Title" />--%>
        ...
        <asp:Parameter Name="EnrollmentID" />
           ...
           <asp:TextBox ID="txtLname1" runat="server"></asp:TextBox>
              <asp:Button ID="RegisterStudentToCourse" runat="server" Text="Register" OnClick="RegisterStudentToCourse_Click" />
              <asp:Button ID="Delete" runat="server" Text="Register" OnClick="Delete_Click" />
